...
const projects = [
  {
    ...
    description:
      "A high-end real estate platform for an exclusive brokerage specializing in luxury properties.",
    image:
  ...
  },
  {
    ...
    description:
      "Modern apartment listing website with advanced filtering and neighborhood insights.",
    image:
  ...
  },
  {
    ...
    description:
      "Personal branding website for a top-performing real estate agent with testimonials and listing showcase.",
    image:
  ...
  },
  {
    ...
    description:
      "Comprehensive admin system for property managers to track rentals, maintenance, and tenant communications.",
    image:
  ...
  },
  {
    ...
    description:
      "B2B platform for commercial property listings with detailed financial data and investor tools.",
    image:
  ...
  },
  {
    ...
    description:
      "Interactive tool helping homeowners estimate their property value based on market data.",
    image:
      "https://images.pexels.com/photos/7579049/pexels-photo-7579049.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    category: "search",
      ...
      <div className="container" ref={ref}>
        ...
        >
          ...
          <p className="text-muted-foreground">
            Browse through my portfolio of specialized real estate web
            development projects, from property listing platforms to agent
            websites and custom admin systems.
          </p>
        </motion.div>
